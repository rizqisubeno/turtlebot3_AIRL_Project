...
from chainer.functions.math.erfc import erfc 
...
class ClippedGaussian2(chainerrl.distribution.GaussianDistribution):
    ...
    def __init__(self, mean, var, low, high):
        ...
        assert isinstance(self.low, Variable)
        assert isinstance(self.high, Variable)
